...
const Stories = () => {
    ...
    return (
        <div className="stories-fragment bg-black flex flex-col justify-center items-center p-24">
            <div
                className={`story-card flex items-center justify-between max-w-5xl w-full text-white px-6 bg-zinc-600 p-8 rounded-lg shadow-xl overflow-hidden md:mx-0 transition-transform transform testimonial-card ${animateDirection === "right" ? "slide-in-right" : ""
